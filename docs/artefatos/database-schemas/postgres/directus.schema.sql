...
\restrict 4xmEfXOFqCZNYWgcQdzqGUVZFtX37x1KlaR6v4Q26BJtmO54tO3eZuGcbR5XBVB
...
--
-- Name: asset_daily_bars; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.asset_daily_bars (
    id integer NOT NULL,
...
--
-- Name: asset_daily_bars_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.asset_daily_bars_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: asset_daily_bars_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.asset_daily_bars_id_seq OWNED BY public.asset_daily_bars.id;
...
--
-- Name: trading_symbols; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: trading_symbols_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.trading_symbols_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: trading_symbols_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--

ALTER SEQUENCE public.trading_symbols_id_seq OWNED BY public.trading_symbols.id;


--
-- Name: asset_daily_bars id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_daily_bars ALTER COLUMN id SET DEFAULT nextval('public.asset_daily_bars_id_seq'::regclass);
...
--
-- Name: trading_symbols id; Type: DEFAULT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trading_symbols ALTER COLUMN id SET DEFAULT nextval('public.trading_symbols_id_seq'::regclass);


--
-- Name: asset_daily_bars asset_daily_bars_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.asset_daily_bars
    ADD CONSTRAINT asset_daily_bars_pkey PRIMARY KEY (id);
...
--
-- Name: trading_symbols trading_symbols_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trading_symbols
    ADD CONSTRAINT trading_symbols_pkey PRIMARY KEY (id);


--
-- Name: trading_symbols trading_symbols_symbol_unique; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.trading_symbols
    ADD CONSTRAINT trading_symbols_symbol_unique UNIQUE (symbol);
...
\unrestrict 4xmEfXOFqCZNYWgcQdzqGUVZFtX37x1KlaR6v4Q26BJtmO54tO3eZuGcbR5XBVB
